...
% Introducao
\include{tex/1-introducao/introducao}

% Data Streams
\include{tex/2-theoretical/theoretical}

% Estudo de Caso
\include{tex/3-estudo-de-caso/estudo_de_caso}

% Objetivos
\include{tex/4-objetivos/obejetivos}

% Aplicações
\include{tex/5-aplicacoes/aplicacoes}

% Conclusão
\include{tex/6-conclusao/conclusao}

% Referências
\include{tex/7-referencias/referencias}
